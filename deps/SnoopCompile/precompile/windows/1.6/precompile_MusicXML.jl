function _precompile_()
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(MusicXML.Type)),NamedTuple{(:attributes, :notes), Tuple{Attributes, Vector{Note}}},Type{Measure}})
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(MusicXML.Type)),NamedTuple{(:scoreparts,), Tuple{Vector{ScorePart}}},Type{PartList}})
